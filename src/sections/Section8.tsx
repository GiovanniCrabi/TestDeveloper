        ...
        <div className="md:mt-0 x-sm:mt-12">
          ...
          <div className="flex mt-6">
            <span className="space-y-5">
              <p className=" text-white text-sm leading-4 opacity-60">Business Plan</p>
              <p className=" text-white text-sm leading-4 opacity-60">About Us</p>
              <p className=" text-white text-sm leading-4 opacity-60">Tecnology</p>
              <p className=" text-white text-sm leading-4 opacity-60">Investor Relations</p>
              <p className=" text-white text-sm leading-4 opacity-60">News & Resources</p>
            </span>
            <span className="space-y-5">
