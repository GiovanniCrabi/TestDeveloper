...
export function Section6() {
  return (
    <div className='w-full md:h-[60rem] x-sm:h-full absolute overflow-hidden'>
      <h1 className='text-white text-5xl leading-[63px] md:pl-28 x-sm:pl-5 mt-20'>Media</h1>
      <div className='md:pl-28 md:mt-12 x-sm:mt-7 flex x-sm:justify-center md:justify-start md:space-x-5 x-sm:space-x-2.5'>
        {CardsDetails.map((cards) => {
          return (
            <div className="md:w-[28rem] x-sm:w-[25rem] md:h-[37rem] x-sm:h-[32rem] relative">
      ...
      <div className="flex pl-28 space-x-3 mt-7 ">
