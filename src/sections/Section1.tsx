...
import AppendDots from "../components/Sliders/Slides";
...
export function Section1() {
  ...
  return (
        ...
        >
          ...
          <div className='w-full flex flex-col items-center text-center absolute'>
            <div className='x-sm:w-80 md:w-full'>
              <h1 className='text-white x-sm:text-5xl md:text-8xl font-normal mt-[22rem]'>Welcome to StarForm</h1>
            ...
            <a className='text-white text-3xl mt-52 hover:text-5xl ' >
              <ArrowCircleDown 
    ...
    <div className={`${open ? 'visible' : 'hidden'} `}>
      <div className='md:flex x-sm:flex-row x-sm:px-6 x-sm:justify-center ease-in duration-300'>
