          ...
          <div className='x-sm:px-5 flex flex-col items-center text-center md:mt-64 x-sm:mt-24'>
            ...
            <div className='flex items-center justify-center mt-32 space-x-2.5'>
              ...
              <div className='flex space-x-3 items-center'>
                <div className="bg-yellow-300 h-2 w-2 rounded-full outline outline-offset-2 outline-2 outline-yellow-300" />
               
                <div className="h-1 w-1 rounded-full border-solid bg-transparent outline outline-offset-2 outline-1 outline-white opacity-40 " />
              </div>
